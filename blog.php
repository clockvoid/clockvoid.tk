...
<div class="flex-container">
    <div id="element">
        ...
        <p>
            IEEE TOWERSの運営として仕事をしてきたこの一年間について，ノウハウを風化させないために，いろいろまとめてみました．
        </p>
    </div>
    <div id="element">
        <strong>
            <a href="./blog.php?content=shibuyaapk29">
                <p>Shibuya.apk 29に行ってきました．</p>
            </a>
        </strong>
        <br>
        <p class="date">2018-10-31</p>
        <p>
            Shibuya.apk 29に行ってきたので，まとめてみました．
        </p>
    </div>
    <div id="element">
        <strong>
            <a href="./blog.php?content=shibuyaapk28">
                <p>Shibuya.apk 28に行ってきました．</p>
            </a>
        </strong>
        <br>
        <p class="date">2018-09-28</p>
        <p>
            Shibuya.apk 28に行ってきたので，まとめてみました．
        </p>
    </div>
    <div id="element">
        <strong>
